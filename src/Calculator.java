...
class Calculator extends JFrame implements ActionListener {
	...
	public static void main(String args[])
	{
        ...
        //Initializing the screen where the inputs and result will be showed. It cannot be edited by just clicking on the text field
        screen = new JTextField(10);
        screen.setHorizontalAlignment(JTextField.RIGHT);
        screen.setEditable(false);

        //Creating the first panel that houses the titles and the screen itself so that its layout can differ from the buttons themselves
        ...
        //An array of buttons so that each creation and addistion does not need to be individually typed out. The order is important here
        String[] buttonArray = {"OFF", "MRC", "M-", "M+", "/", "%", "7", "8", "9", "*", "√", "4", "5", "6", "-", "C", "1", "2", "3", "+", "AC", "0", ".", "="};

        //For loop to go through the buttonArray, create each button and add them to the second panel
    ...
    //This is the main method that will activate whenever a button that has a listener on it is pressed on the calculator
	public void actionPerformed(ActionEvent e)
	{
        //The e.getActionCommand() method listens to see exactly which button is pressed
